...
public class MFenced extends LayoutSchemata {
	...
	public void render(Surface canvas, Area area, InteractionSocket socket) {
		...
		if (closeFenceType == FenceType.VERTICAL_BAR){
			ShapeBuilder sb = new ShapeBuilder();
			canvas.setLineWidth(getVerticalBarLineThickness());
			sb.drawLineSegment((int)(exactArea.x + exactArea.width - closeBracketSize.width/2), exactArea.y, (int)(exactArea.x+ exactArea.width - closeBracketSize.width/2), exactArea.y + exactArea.height);
			canvas.strokeShape(sb.build());
		} else {
